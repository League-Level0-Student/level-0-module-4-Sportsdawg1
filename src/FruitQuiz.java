...
public class FruitQuiz extends KeyAdapter {
	...
	void makeQuestions() {
		...
		question2 = new JLabel("<html>What fruit is not a real fruit and deserves to be burned? <br> A: Dragon Fruit <br> B: Durian <br> C: tomato</html>");
		question3 = new JLabel("<html>Which is not a real fruit? <br> A: Dragon Fruit <br> B: Durian <br> C: Crazyberry</html>");
		question4 = new JLabel("<html>What fruit is not a real fruit and deserves to be burned? <br> A: Dragon Fruit <br> B: Durian <br> C: tomato</html>");
